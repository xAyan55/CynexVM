...
<p style="font-size:14px;line-height:1.6;color:#374151;margin:0 0 16px 0">Your account has been created successfully. You now have access to the {{branding.panel_name}} control panel where you can manage your virtual servers, monitor resources, and configure your infrastructure.</p>
<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:24px 0">
  <tr>
    <td align="center" style="background-color:{{branding.button_color}};border-radius:{{branding.border_radius}}">
      <a href="{{branding.website}}" style="display:inline-block;padding:12px 32px;font-size:14px;font-weight:600;color:#ffffff;text-decoration:none">Go to Dashboard</a>
    </td>
  </tr>
</table>
<div style="margin-top:24px;padding:16px;background-color:#f9fafb;border-radius:{{branding.border_radius}};font-size:13px;color:#6b7280">
...
<p style="font-size:14px;line-height:1.6;color:#374151;margin:0 0 16px 0">We received a request to reset the password for your {{branding.panel_name}} account.</p>
<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:24px 0">
  <tr>
    <td align="center" style="background-color:{{branding.button_color}};border-radius:{{branding.border_radius}}">
...
<p style="font-size:14px;line-height:1.6;color:#374151;margin:0 0 16px 0">Your {{branding.panel_name}} account password was just changed.</p>
<div style="margin:24px 0;padding:16px;background-color:#fef3cd;border-radius:{{branding.border_radius}};font-size:13px;color:#856404">
...
<p style="font-size:14px;line-height:1.6;color:#374151;margin:0 0 16px 0">Your {{branding.panel_name}} account email address has been changed.</p>
<div style="margin:24px 0;padding:16px;background-color:#f3f4f6;border-radius:{{branding.border_radius}};font-size:13px;color:#374151">
...
<p style="font-size:14px;line-height:1.6;color:#374151;margin:0 0 16px 0">Your {{branding.panel_name}} account has been temporarily locked due to too many failed login attempts.</p>
<div style="margin:24px 0;padding:16px;background-color:#fee2e2;border-radius:{{branding.border_radius}};font-size:13px;color:#991b1b">
...
<p style="font-size:14px;line-height:1.6;color:#374151;margin:0 0 16px 0">A new sign-in was detected on your {{branding.panel_name}} account.</p>
<div style="margin:24px 0;padding:16px;background-color:#f3f4f6;border-radius:{{branding.border_radius}};font-size:13px;color:#374151">
...
<p style="font-size:14px;line-height:1.6;color:#374151;margin:0 0 16px 0">Two-factor authentication was just disabled on your {{branding.panel_name}} account.</p>
<div style="margin:24px 0;padding:16px;background-color:#fef3cd;border-radius:{{branding.border_radius}};font-size:13px;color:#856404">
...
<p style="font-size:14px;line-height:1.6;color:#374151;margin:0 0 16px 0">A new API key was generated for your {{branding.panel_name}} account.</p>
<div style="margin:24px 0;padding:16px;background-color:#f3f4f6;border-radius:{{branding.border_radius}};font-size:13px;color:#374151">
...
<p style="font-size:14px;line-height:1.6;color:#374151;margin:0 0 16px 0">An API key was revoked for your {{branding.panel_name}} account.</p>
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:24px 0">
  <tr>
    <td align="center" style="background-color:{{branding.button_color}};border-radius:{{branding.border_radius}}">
      <a href="{{branding.website}}/instances/{{instance_id}}" style="display:inline-block;padding:12px 32px;font-size:14px;font-weight:600;color:#ffffff;text-decoration:none">Manage Container</a>
    </td>
  </tr>
</table>`,
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:24px 0">
  <tr>
    <td align="center" style="background-color:{{branding.button_color}};border-radius:{{branding.border_radius}}">
      <a href="{{branding.website}}/instances/{{instance_id}}" style="display:inline-block;padding:12px 32px;font-size:14px;font-weight:600;color:#ffffff;text-decoration:none">Open Console</a>
    </td>
  </tr>
</table>`,
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:24px 0">
  <tr>
    <td align="center" style="background-color:{{branding.button_color}};border-radius:{{branding.border_radius}}">
      <a href="{{branding.website}}/instances/{{instance_id}}" style="display:inline-block;padding:12px 32px;font-size:14px;font-weight:600;color:#ffffff;text-decoration:none">Open Container</a>
    </td>
  </tr>
</table>`,
...
<p style="font-size:14px;line-height:1.6;color:#374151;margin:0 0 16px 0">We will be performing scheduled maintenance on {{branding.panel_name}}.</p>
<div style="margin:24px 0;padding:16px;background-color:#f3f4f6;border-radius:{{branding.border_radius}};font-size:13px;color:#374151">
...
<p style="font-size:14px;line-height:1.6;color:#374151;margin:0 0 16px 0">A new invoice has been generated for your {{branding.panel_name}} account.</p>
<div style="margin:24px 0;padding:16px;background-color:#f3f4f6;border-radius:{{branding.border_radius}};font-size:13px;color:#374151">
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:24px 0">
  <tr>
    <td align="center" style="background-color:{{branding.button_color}};border-radius:{{branding.border_radius}}">
      <a href="{{branding.website}}/billing/invoices/{{invoice_id}}" style="display:inline-block;padding:12px 32px;font-size:14px;font-weight:600;color:#ffffff;text-decoration:none">View Invoice</a>
    </td>
  </tr>
</table>`,
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:24px 0">
  <tr>
    <td align="center" style="background-color:{{branding.button_color}};border-radius:{{branding.border_radius}}">
      <a href="{{branding.website}}/billing" style="display:inline-block;padding:12px 32px;font-size:14px;font-weight:600;color:#ffffff;text-decoration:none">Update Billing</a>
    </td>
  </tr>
</table>`,
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:24px 0">
  <tr>
    <td align="center" style="background-color:{{branding.button_color}};border-radius:{{branding.border_radius}}">
      <a href="{{branding.website}}/support/tickets/{{ticket_id}}" style="display:inline-block;padding:12px 32px;font-size:14px;font-weight:600;color:#ffffff;text-decoration:none">View Reply</a>
    </td>
  </tr>
</table>`,
...
{{#action_url}}<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:24px 0"><tr><td align="center" style="background-color:{{branding.button_color}};border-radius:{{branding.border_radius}}"><a href="{{action_url}}" style="display:inline-block;padding:12px 32px;font-size:14px;font-weight:600;color:#ffffff;text-decoration:none">View Details</a></td></tr></table>{{/action_url}}
<hr style="border:0;border-top:1px solid #e5e7eb;margin:24px 0" />
<p style="font-size:12px;color:#9ca3af;margin:0">This is an automated notification from {{branding.panel_name}}. Manage preferences in your Profile settings.<br/>Event: {{category}} &middot; {{time}}</p>`,
    plainText: `{{title}}
...
<p style="font-size:14px;line-height:1.6;color:#374151;margin:0 0 16px 0">Your periodic security summary for {{branding.panel_name}}.</p>
<div style="margin:24px 0;padding:16px;background-color:#f3f4f6;border-radius:{{branding.border_radius}};font-size:13px;color:#374151">
